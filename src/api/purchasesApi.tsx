...
export const addPurchase = async ({CategoryID, PurchaseDate, Notes}:Purchase): Promise<Purchase> => {
	const res = await api.post(purchaseUrlEndpoint, {CategoryID, PurchaseDate, Notes});
	return res.data.value;
}
